...
function addon:setupZoneReminder()
	...
	self.zoneReminderSettings = {
		...
		['Highmaul'] = {
			...
			['Market District'] = { -- Tectus 
				[{256, 257}] = {
					talents = {
					},
				},
			},
			['Gorian Strand'] = { -- Brackenspore 
				[{256, 257}] = {
					talents = {
					},
				},
			},
			['The Underbelly'] = { -- Butcher
				[{256, 257}] = {
					talents = {
						[6] = 1,
					},
			...
			['The Gorthenon'] = { -- Twin Ogron
				[{256, 257}] = {
					talents = {
					},
				},
			},
			['Chamber of Nullification'] = { -- Ko'ragh
				[{256, 257}] = {
					talents = {
						[6] = 1,
					},
...
function addon:setupBars()
	self.actionBarSettings = {
		--!!1
		[001] = { { specs = {62, 63, 64},           spell = 'Frostfire Bolt' },
		...
		--!!2
		[002] = { { specs = {62, 63, 64},           spell = 'Fire Blast' },
		...
		--!!3
		[003] = { { specs = {62, 63, 64},           spell = 'Cone of Cold' },
		...
		--!!4
		[004] = { { specs = {62},           		spell = 'Arcane Missiles' }, 
		...
		--!!5
		[005] = { { specs = {62, 63, 64},           spell = 'Remove Curse' },
		...
		--!!Q
		[006] = { { specs = {65, 66, 70},           spell = 'Reckoning' },
		...
		--!!C 
		[008] = { { specs = {62},           		spell = 'Arcane Explosion' }, 
		...
		--!!V
		[009] = '<item>109076', -- Goblin Glider Kit
		--!!R
		[010] = { { specs = {63},           		spell = 'Flamestrike' }, 
		...
		--!!B
		[011] = { { specs = {62, 63, 64},           spell = 'Ice Block' },
		...
		--!!G
		[012] = { { specs = {62, 63, 64},           spell = 'Slow Fall' },
		...
		-- ############################################# 2
		--!!S1
		[013] = { { specs = {62, 63, 64}, 			spell = 'Arcane Brilliance' },
		...
		--!!S2
		[014] = { { specs = {65, 66, 70},           spell = 'Blessing of Might' },
		...
		--!!S3
		[015] = { { specs = {65, 66, 70},           spell = 'Righteous Fury' },
		...
		--!!S4
		[016] = { { specs = {102, 103, 104, 105},   spell = 'Teleport: Moonglade' },
		...
		--!!SQ
		[018] = { { specs = {62, 63, 64},           spell = 'Invisibility' },
		...
		--!!SE
		[019] = { { specs = {65, 66, 70},           spell = 'Flash of Light' },
		...
		--!!SC
		[020] = { { specs = {62, 63, 64},           spell = 'Amplify Magic' },
		...
		[021] = '<macro>TankCd2',
		--!!CR
		[022] = { { specs = {66},           		spell = 'Consecration' },
		...
		--!!SB
		[023] = { { specs = {62, 63, 64},           spell = '<flyout>Teleport' },
		...
		--!!SG
		[024] = { { specs = {62, 63, 64},           spell = '<flyout>Portal' },
		...
		-- ############################################# 3
		--!!C1
		[025] = { { specs = {65, 66, 70},           spell = '<macro>HandOfPurity' },
		...
		--!!C2
		[026] = { { specs = {65, 66, 70},           spell = '<macro>PaladinTier6' },
		...
		--!!C3
		[027] = { { specs = {65},           		spell = 'Light of Dawn' },
		...
		--!!C4
		[028] = { { specs = {65},           		spell = 'Holy Radiance' },
		...
		--!!S'
		[029] = { { specs = {65, 66, 70},           spell = 'Redemption' },
		...
		--!!CQ 
		[030] = { { specs = {62},           		spell = 'Presence of Mind' },
		...
		--!!CE
		[031] = { { specs = {65, 66, 70},           spell = 'Word of Glory' },
		...
		[032] = '<macro>Slot6',
		--!!AV
		[033] = { { specs = {65, 66, 70},           spell = 'Divine Protection' },
		...
		--!!AR
		[034] = { { specs = {253, 254, 255},        spell = 'Ice Trap' },
				  { specs = {261},        			spell = 'Premeditation' }, },
		--!!CB
		[035] = { { specs = {62},           		spell = 'Slow' }, 
		...
		--!!CG
		[036] = { { specs = {62, 63, 64},           spell = 'Conjure Refreshment Table' },
		...
		-- ############################################# 4
		--!!CS1
		[037] = { { specs = {65, 66, 70},           spell = 'Seal of Insight' },
		...
		--!!CS2
		[038] = { { specs = {66, 70},           	spell = 'Seal of Righteousness' },
		...
		--!!CS3
		[039] = { { specs = {70},           		spell = 'Seal of Justice' },
		...
		[042] = '<macro>Slot13',
		--!!CSE
		[043] = { { specs = {64},           		spell = 'Summon Water Elemental' }, 
		...
		--!!X
		[045] = { { classes = {'MAGE', 'PRIEST', 'WARLOCK'},        spell = 'Shoot' },
		...
		[047] = '<macro>StopPet',
		--!!CSG
		[048] = { { specs = {62, 63, 64},           spell = 'Conjure Refreshment' },
		...
		-- ############################################# 5
		--!!T
		[049] = { { specs = {62},           		spell = 'Arcane Power' }, 
		...
		--!!CSp
		[050] = { { specs = {250, 251, 252},        spell = '<macro>PlagueLeech' },
		...
		[052] = '<macro>Yak',
		--!!SA
		[053] = { { races = {'Blood Elf'},	        spell = 'Arcane Torrent' },
				  { races = {'Troll'},	        	spell = 'Berserking' },
				  { races = {'Draenei'},	        spell = 'Gift of the Naaru' }, },
		--!!CA
		[054] = { { specs = {62, 63, 64},           spell = 'Spellsteal' },
		...
		--!!CSA
		[055] = { { specs = {62, 63, 64},           spell = 'Frost Nova' },
		...
		--!!CSS
		[058] = { { specs = {65, 66, 70},           spell = 'Hand of Sacrifice' },
		...
		--!!AF 
		[059] = { { specs = {65, 66, 70},           spell = '<macro>SpeedOfLight' },
		...
		--!!AG
		[060] = { { cats = {'STR'},			        spell = '<item>109219' },	-- Draenic Strength Potion
				  { cats = {'AGI'},			        spell = '<item>109217' },	-- Draenic Agility Potion
				  { cats = {'INT'},			        spell = '<item>109218' }, }, -- Draenic Intellect Potion
		
		-- ############################################# 6
		--!!CST
		[061] = { { specs = {66},           		spell = 'Guardian of Ancient Kings' },
		...
		[062] = '<macro>Slot14',
		--!!CS'
		[063] = { { specs = {102, 103, 104, 105},   spell = 'Rebirth' },
				  { specs = {250, 251, 252},        spell = 'Raise Ally' },
				  { specs = {265, 266, 267},        spell = 'Soulstone' }, },
		--!!CV
		[064] = { { specs = {250, 251, 252},        spell = '<macro>UnholyBlight' },
		...
		--!!SV
		[065] = { { specs = {62, 63, 64},           spell = 'Time Warp' },
		...
		--!!F2
		[069] = '<item>115009', -- Improved Iron Trap
		
		--!!F3
		[070] = 'Garrison Ability', 
		
		[071] = { { professions = {'Enchanting'},   spell = 'Enchanting' },
				  { professions = {'Alchemy'},		spell = 'Alchemy' }, },
		
		[072] = { { professions = {'Engineering'},  spell = 'Engineering' },
				  { professions = {'Tailoring'},    spell = 'Tailoring' },
				  { professions = {'Inscription'},  spell = 'Inscription' }, },
		
		-- ############################################# 7
		--!!CSW
		[073] = '<item>109223', -- Healing Tonic
		--!!ASp
		[074] = { { specs = {253, 254, 255},        spell = 'Tame Beast' },
		...
		[075] = { { cats = {'INT'},        	spell = '<item>109155' },		-- Greater Draenic Intellect Flask
				  { cats = {'STR'},        	spell = '<item>109156' },		-- Greater Draenic Strength Flask
				  { cats = {'AGI'},        	spell = '<item>109153' }, }, 	-- Greater Draenic Agility Flask
		
		[076] = { { cats = {'STA'},        	spell = '<item>109160' },       -- Greater Draenic Stamina Flask
				  { cats = {'SPI'}, 		spell = '<item>109222' }, }, 	-- Draenic Mana Potion
		
		[077] = { { cats = {'STA'}, 		spell = '<item>109220' },       -- Draenic Armor Potion
				  { cats = {'SPI'}, 		spell = '<item>109221' }, },    -- Draenic Channeled Mana Potion
		
		[078] = { { cats = {'INT'},        	spell = '<item>118632' },		-- Focus Augment Rune
				  { cats = {'STR'},        	spell = '<item>118631' },		-- Stout Augment Rune
				  { cats = {'AGI'},        	spell = '<item>118630' }, }, 	-- Hyper Augment Rune
		...
		[084] = '<item>116268', -- Draenic Invisibility Potion
		
		-- ############################################# 8
		--!!SD
		[085] = { { specs = {62, 63, 64},           spell = 'Polymorph' },
		...
		--!!CSD
		[086] = { { specs = {62, 63, 64},           spell = 'Counterspell' },
		...
		[095] = '<item>113509', -- Conjured Mana Fritter
		
		[096] = { { cats = {'INT'},			        spell = '<item>117452' }, }, -- Gorgrond Mineral Water
		
		-- ############################################# 9
		
		[097] = '<item>6948', -- Hearthstone
		
		[098] = '<item>44934', -- Loop of the Kirin Tor
		
		[099] = '<item>65274', -- Cloak of Coordination
		
		[100] = '<item>64402', -- Battle Standard of Coordination
		
		[101] = '<item>118662', -- Bladespire Relic
		
		[102] = '<macro>BlazingWings', -- Blazing Wings
		
		[103] = '<item>110560', -- Garrison Hearthstone
		...
		[110] = '<item>86143', -- Battle Pet Bandage
		
		[111] = 'Fishing',
		
		[112] = { { professions = {'Enchanting'},   spell = 'Disenchant' },
